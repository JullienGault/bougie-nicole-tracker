...
// NOUVEAU : Importations pour l'export PDF (avec une astuce de chargement dynamique)
// Ces imports sont nécessaires pour que le code soit valide, mais la logique de chargement dynamique ci-dessous est utilisée.
// Vous devez toujours lancer : npm install jspdf jspdf-autotable
...
// ... Le reste des composants sera défini à la fin
// ... (Ici le code complet des composants `PosDashboard` et `AdminDashboard`)
...
export default function App() {
    ...
    // Chargement dynamique des librairies PDF pour éviter les problèmes de build
    useEffect(() => {
        if (pdfReady) return;
    ...
    // Chargement du catalogue depuis Firestore
    useEffect(() => {
        if(!db) return;
